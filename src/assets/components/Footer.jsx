...
export const Footer = () => {
    ...
    return(
        <>
            <footer>
                <div className='grid md:grid-cols-3 grid-cols-1 bg-gradient-to-b from-[#249382]/10 to-theme-blue text-white text-center h-auto justify-center items-center'>
                    ...
                    <div className='flex h-full'>
                        <div className='flex p-3 flex-col text-center mx-auto'>
                            ...
                            <div className='p-4 text-start'>
                                ...
                                <p className='mt-8 italic'>liceobzl@gmail.com</p>
                            </div>
                        </div>
                    </div>
                    <div className='flex h-full'>
