                ...
                <div>
                    <div className='p-5 mx-auto grid grid-cols-1 md:grid-cols-2'>
                        ...
                        <div className='flex my-20'>
                            <img src="/src/imgs/hero-documentos.avif" className=' w-70 md:w-90 lg:w-120 mx-auto my-auto rounded-lg shadow-xl  shadow-amber-50 -skew-2 hover:skew-2 transition-all duration-300' alt="" />
                        </div>
                    </div>
                </div>
