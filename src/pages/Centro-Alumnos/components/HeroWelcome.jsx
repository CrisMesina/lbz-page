...
export const HeroWelcome = () => {
    ...
    return (
        <>
            <div className=''>
                <svg
                className={`absolute top-0 right-0 h-full 2xl:w-250 lg:w-230 -z-1 ${isMobile ? '' : 'animation-show-right'}`}
            ...
            >
                ...
                <img src="/alumnos.avif" className={`absolute hidden lg:block right-0 bottom-0 xl:h-150 2xl:h-210 z-5 ${isMobile ? '' : 'animation-show-right'}`} alt="Ilustración de estudiantes del liceo" />
