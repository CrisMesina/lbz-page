        ...
        <>
            ...
            <div>
                ...
                >
                    ...
                    <img src="/hero1-min.avif" className={`absolute ${isMobile ? 'clip-horizontal h-screen object-cover' : 'clip w-full'} animation-popup `} alt="Imagen de portada para la sección Centro de Alumnos" />
