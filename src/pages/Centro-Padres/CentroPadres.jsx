                ...
                <div>
                    <div className='p-5 mx-auto grid-cols-1 grid md:grid-cols-2'>
                        ...
                        <div className='flex mt-20 md:mt-0'>
                            <img src="/src/imgs/hero-documentos.avif" className='w-70 md:w-96 lg:w-120 mx-auto my-auto rounded-lg shadow-xl  shadow-amber-50 -skew-2 hover:skew-2 transition-all duration-300' alt="" />
                        </div>
                    </div>
                </div>
