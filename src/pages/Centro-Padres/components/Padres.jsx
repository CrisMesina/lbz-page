...
export const Padres = () => {
    ...
    return (
        <>
            <h1 className='text-center font-bold text-4xl' id='padres'>¿Quienes forman parte del centro de Padres</h1>
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 p-5'>
                    {listado.map((a, i) =>(
                        <div key={i} className='w-60 skew-1 hover:scale-105 shadow-lg active:shadow-green-600 mx-auto my-5 rounded-t-2xl bg-gradient-to-b from-theme-blue to-[#249382] rounded-b-2xl text-center'>
                            <div>
                                <img src={a.image.length < 2 ? '/default-profile.avif' : a.image} alt="Imagen de la persona que esta encargada de su cargo (Presidente, tesorera, etc)" 
