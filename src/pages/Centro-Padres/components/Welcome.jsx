        ...
        <>
            ...
            <div>
                ...
                >
                    ...
                    <img src="/PortadaCentroPadres.avif" className={`absolute ${isMobile ? 'clip-horizontal h-screen object-cover' : 'clip w-full'} ${isMobile ? '': 'animation-popup'} `} alt="Imagen de portada para la sección Centro de Padres" />
                    ...
                    <div className="relative z-10 max-w-4xl mx-auto text-center md:text-left">
                        ...
                        <p className='text-xl md:text-2xl text-theme-celeste-claro mb-8 font-light max-w-3xl mx-auto'>
                            Conoce más sobre nuestro centro de padres
                        </p>
                    </div>
                </header>
