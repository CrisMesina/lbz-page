...
export const  Contactos = () => {
    ...
    const contactos = [
        ...
        },
        {
            id:3,
            name: "Institución",
            img: "/src/imgs/Logo.png", // ubicacion de imagenes -> /src/imgs/
                                ...
                                <div className='h-1/2 rounded-t-xl bg-gradient-to-t from-green-950 via-green-700 to-theme-old-green-nav'></div>{/* Fondo Superior */}
                                    <div className='bottom-1/4 bg-white w-80 left-1 absolute'> {/* Informacion Contacto */}
                                        <div className='relative rounded-full'>
                                            <img src={`${c.img.length < 2 ? "/src/imgs/default-profile.avif" : c.img}`} className='rounded-full object-cover hover:scale-105 z-1 bg-white p-2 absolute w-25 bottom-13 h-25 left-1/3'  alt="" />
                                        </div>
                                    </div>
                                        ...
                                        <div className='flex flex-col'>
                                            ...
                                            <div className={`grid  ${c.telefono ? 'grid-cols-2' : 'grid-cols-1'} my-4`}>
                                                <a href={`tel:${c.telefono}`} className='flex p-2 w-auto mx-auto'>
                                                    ...
                                                    >
                                                        <img src="/src/imgs/email-icon.svg" className='w-6 h-6 inline mx-2' alt="" />
                                                        Correo
                                                    </button>
                                                </a>
                                                {c.telefono &&(
                                                    <a href={`tel:${c.telefono}`} className='flex p-2 w-auto mx-auto'>
                                                        <button
                                                            ...
                                                            <img src="/src/imgs/phone-call.svg" className='w-6 h-6 inline mx-2' alt="" />
                                                            Llamar
                                                        </button>
                                                    </a>
                                                )}
