...
export const Malla = () => {
    ...
    const tercero = [
        {
            ramo: "Utilización de información contable"
        },
        {
            ramo: "Gestión comercial y tributaria"
        },
        {
            ramo: "Procesos administrativos"
        },
        {
            ramo: "Organización de oficinas"
        },
        {
            ramo: "Aplicaciones informáticas para la gestión administrativa"
        }
    ]

    const cuarto = [
        {
            ramo: "Legislación laboral"
        },
        {
            ramo: "Cálculo de remuneración, finiquitos y obligaciones laborales"
        },
        {
            ramo: "Desarrollo y bienestar del personal"
        },
        {
            ramo: "Dotación de personal"
        },
        {
