            ...
            <div>
                ...
                <div className=''>
                    ...
                    <div className='text-center my-10 '>
                        <button name="ver-mas-documentos" className='text-white p-5 rounded-lg bg-gradient-to-r from-blue-950 to-blue-900/30 hover:translate-y-2 shadow-md shadow-amber-50'>
