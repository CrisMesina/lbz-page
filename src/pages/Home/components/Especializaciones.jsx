                            ...
                            >
                                ...
                                <div className='flex-col text-center mt-5 p-4'>
                                    <div className='relative justify-center w-30'>
                                        <img src={e.img} className='absolute w-auto h-30 rounded-full left-22 xl:left-15 -top-30 2xl:-top-30 2xl:left-22 xl:-top-25 bg-[#249382] p-1' alt={e.alt} />
                                    </div>
                                    <h1 className='font-bold my-3 xl:my-5 2xl:my-5'>{e.title}</h1>
                                    <p>{e.text}</p>
                                    <a href={e.href}>
                                        <button name="especializacion" aria-label={`Ver más sobre ${e.title}`} className='shadow-md active:translate-y-2 shadow-green-600 hover:shadow-[#249382] hover:scale-105  cursor-pointer p-4 mt-5 rounded-xl w-32'>
                                            Ver más
                                        </button>
                                    </a>
                                </div>
