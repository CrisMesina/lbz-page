        ...
        <>
            ...
            <div>
                ...
                >
                    ...
                    <img src="/portadaIndex2.avif" className={`absolute ${isMobile ? 'clip-horizontal h-screen object-cover' : 'clip '} ${isMobile ? '': 'animation-popup'} w-full`} alt="Imagen de portada del Liceo Berta Zamorano Lizana" />
