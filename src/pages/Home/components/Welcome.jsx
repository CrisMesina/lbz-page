        ...
        <>
            ...
            <div>
                ...
                >
                    ...
                    <img src="/portadaIndex2.avif" className={`absolute ${isMobile ? 'clip-horizontal h-screen object-cover' : 'clip w-full'} ${isMobile ? '': 'animation-popup'}`} alt="Imagen de portada del Liceo Berta Zamorano Lizana" />
