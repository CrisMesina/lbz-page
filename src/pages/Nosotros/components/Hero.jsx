        ...
        <>
            ...
            <div>
                ...
                >
                    ...
                    <img src="/portadaIndex.avif" className={`absolute ${isMobile ? 'clip-horizontal h-screen object-cover' : 'clip w-full'} animation-popup `} alt="Imagen de portada para la sección Sobre Nosotros" />
