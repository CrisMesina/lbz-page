    ...
    return(
        <>
            <div className='flex flex-col md:flex-row'>
                <div className='text-center mx-auto w-full my-10 h-96 p-2 scroll-items-left'>
                ...
                <div className='text-center mx-auto w-full h-110 bg-black my-10 text-white p-2 scroll-item-right'>
